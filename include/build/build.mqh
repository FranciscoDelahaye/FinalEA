...
bool build(SData &Sdata[][][], SIndicator &Sindi[], SSymbol &Ssymb[]){
   ...
   if(SymbolListSize==0 || IndicatorSize==0 || TimeframeSize==0){ return false;  }
   
   //Construimos e iniciamos estructura de indicadores
   ...
   //Construimos e iniciamos estructura de simbolos
   buildSSymbol(Ssymb, SymbolListSize);
   initSymbol(Ssymb);
   
   //Contruimos e iniciamos estructura Data
